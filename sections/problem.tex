...
\begin{figure*}[h]
\subfloat[Incorrect Pose Percentage w.r.t Viewing Angle ]{\includegraphics[width=\columnwidth, height=160px]{figs/simulation_rotation}
\label{fig:simulation_rotation}} 
\subfloat[Incorrect Pose Percentage w.r.t Distance]{\includegraphics[width=\columnwidth, height=160px]{figs/simulation_trans}
